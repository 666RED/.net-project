<%@ Page Title="" Language="C#" MasterPageFile="~/Master Page/MasterPage.Master" AutoEventWireup="true" CodeBehind="ViewBorrowHistory.aspx.cs" Inherits="Net_project.ViewBorrowHistory" %>
        ...
        <table class="table table-hover table-bordered border-secondary mt-4">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="col-2 text-center">Borrower Name</th>
                ...
                <asp:Repeater ID="BorrowTable" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="text-center"><%# Eval("borrowerName") %></td>
